...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        watch: {
            ...
            files: ["src/**/*.html", "build/less/*.less", "build/less/skins/*.less", "dist/js/app.js", "documentation/build/*.html", "documentation/build/include/*.html"],
            tasks: ["less", "uglify", "includereplace"]
        },
        ...
        includereplace: {
            src: {
                files: [
                    ...
                    {src: 'documentation/*.html', dest: 'dist', expand: true, cwd: 'src/'},
                    {src: 'documentation/*.js', dest: 'dist', expand: true, cwd: 'src/'},
                    {src: 'documentation/*.css', dest: 'dist', expand: true, cwd: 'src/'}
                ]
            }
        }
    });
    ...
    grunt.registerTask('default', ['less','includereplace', 'watch']);
    grunt.registerTask('static',['includereplace'])
};
